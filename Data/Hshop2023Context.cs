...
public partial class Hshop2023Context : DbContext
{
	...
	public Hshop2023Context(DbContextOptions<Hshop2023Context> options) : base(options)
	{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		{
			// Specify the key for IdentityUserLogin
			entity.HasKey(l => new { l.LoginProvider, l.ProviderKey });
		});

		modelBuilder.Entity<IdentityUserRole<string>>(entity =>
		{
			// Specify the key for IdentityUserRole
			entity.HasKey(r => new { r.UserId, r.RoleId });
		});

		modelBuilder.Entity<IdentityUserClaim<string>>(entity =>
		{
			// Specify the key for IdentityUserClaim
			entity.HasKey(c => c.Id);
		});

		modelBuilder.Entity<IdentityRoleClaim<string>>(entity =>
		{
			// Specify the key for IdentityRoleClaim
			entity.HasKey(c => c.Id);
		});
